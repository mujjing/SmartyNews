       ...
       var segmentControl: WBSegmentControl!
        ...
        func initSegmentControl() {
            ...
            segmentControl.segments = [
                TextSegment(text: "first", otherAttr: "first"),
                TextSegment(text: "second", otherAttr: "second"),
                TextSegment(text: "third", otherAttr: "third"),
                TextSegment(text: "fourth", otherAttr: "fourth"),
                TextSegment(text: "fifth", otherAttr: "fifth"),
                        ]
